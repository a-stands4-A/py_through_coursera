...
затем действительное число x, затем следует n+1 вещественных чисел —
...
Oksana Tkhorik
2 месяца назад
"for in range " всегда можно заменить на "while n + 1 != 0".
Вот мое решение, очень похожее на представленное выше.
